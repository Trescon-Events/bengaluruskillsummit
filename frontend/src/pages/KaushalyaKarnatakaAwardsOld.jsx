    ...
    <div className="kka-old-page">
      <style>{`
        ...
        .vc_custom_1759240554946 {
          background-image: url(/bengaluruskillsummit/wp-content/uploads/2025/09/corporate-excellence-awards-bg.webp) !important;
          background-position: center !important;
          background-repeat: no-repeat !important;
          background-size: cover !important;
        }
        .vc_custom_1759238383085 {
          background-image: url(/bengaluruskillsummit/wp-content/uploads/2025/09/CEA-award-category-bg.webp) !important;
          background-position: center !important;
          background-repeat: no-repeat !important;
          background-size: cover !important;
        }
        .vc_custom_1759241199159 {
          background-image: url(/bengaluruskillsummit/wp-content/uploads/2025/09/institutional-excellence-awards-bg.webp) !important;
          background-position: center !important;
          background-repeat: no-repeat !important;
          background-size: cover !important;
        }
