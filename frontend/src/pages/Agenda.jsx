    ...
    <>
      <div id="ajax-content-wrap">
        <style>{`
          ...
          .agenda-hero {
            position: relative;
            background-image: linear-gradient(135deg, rgba(0,0,0,0.72) 0%, rgba(6,45,64,0.68) 100%), url('/bengaluruskillsummit/wp-content/uploads/2025/09/agenda-banner.webp');
