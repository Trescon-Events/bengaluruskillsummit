...
export default function BeAMediaPartner() {
  useEffect(() => {
    ...
    const renderHubspot = () => {
      ...
      if (window.hbspt && container) {
        ...
        window.hbspt.forms.create({
          portalId: "2953901",
          formId: "1ed6453d-98ea-4e7f-9858-89398d1f4a61",
          region: "na1",
  ...
  return (
    <div className="bss-media-partner-page" style={{ fontFamily: '"Comfortaa", sans-serif', color: '#0e1220' }}>
      <style>{`
        /* ---------------- HERO BANNER ---------------- */
      ...
      {/* Hero Banner */}
      <section className="bss-media-partner-hero">
        <div className="bss-media-partner-hero__container">
          <h1 className="bss-media-partner-hero__title">
            Be a Media Partner
          </h1>
        </div>
      </section>
      ...
      {/* HubSpot Form Section */}
      <section className="bss-media-partner-form-section">
        <div className="bss-media-partner-form-container">
          <div id="hubspot-media-partner-form"></div>
        </div>
      </section>
