...
import partnersCategories from '../data/ecosystem_partners.json';
import mediaPartnersCategories from '../data/media_partners.json';
export default function EcosystemPartners({ isScreen = false }) {
  useEffect(() => {
    document.title = isScreen
      ? 'Ecosystem Partners | Bengaluru Skill Summit'
      : 'Ecosystem Partners - Bengaluru Skill Summit';
    window.scrollTo(0, 0);
  }, [isScreen]);

  const categoriesToDisplay = isScreen
    ? [...partnersCategories, ...mediaPartnersCategories]
    : partnersCategories;
  return (
    <div className="ecosystem-partners-page">
      <style>{`
        /* =============================================
      ...
      <div className="partners-section-wrap">
        <div className="partners-section">
          {categoriesToDisplay.map((group, groupIdx) => (
