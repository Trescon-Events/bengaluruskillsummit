...
export default function Register() {
  useEffect(() => {
    document.title = 'Register | Contact Bengaluru Skill Summit 2026 Team';
    window.scrollTo(0, 0);

    let intervalId = null;

    const renderHubspot = () => {
      const container = document.getElementById('hubspot-register-form');
      if (window.hbspt && container) {
        ...
        window.hbspt.forms.create({
          portalId: "2953901",
          formId: "5c2caa2a-9b65-4131-b90f-d350b97f22a9",
          region: "na1",
          target: "#hubspot-register-form",
  ...
  return (
    <div className="bss-register-page" style={{ fontFamily: '"Comfortaa", sans-serif', color: '#0e1220' }}>
      <style>{`
        /* ---------------- HERO BANNER ---------------- */
        .bss-register-hero {
          width: 100%;
      ...
      {/* Hero Banner */}
      <section className="bss-register-hero">
        <div className="bss-register-hero__container">
          <h1 className="bss-register-hero__title">
      ...
      {/* HubSpot Form Section */}
      <section className="bss-register-form-section">
        <div className="bss-register-form-container">
          <div id="hubspot-register-form"></div>
        </div>
      </section>
