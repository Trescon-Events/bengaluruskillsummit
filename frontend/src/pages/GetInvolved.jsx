  ...
  return (
    <>
      ...
      [id^="fws_"].top-level.full-width-section {
        ...
        background-image: linear-gradient(rgba(13, 27, 62, 0.45), rgba(13, 27, 62, 0.55)), url("/bengaluruskillsummit.com/wp-content/uploads/2025/09/agenda-banner.webp") !important;
