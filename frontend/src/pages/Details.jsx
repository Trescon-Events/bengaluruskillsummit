  ...
  const cards = [
    {
      id: 'agenda',
      title: 'Agenda',
      icon: '/bengaluruskillsummit/wp-content/uploads/2025/10/agenda.svg',
      link: '/agenda',
      width: 59,
      height: 60,
    },
    {
      id: 'floorplan',
      title: 'Floorplan',
      icon: '/bengaluruskillsummit/wp-content/uploads/2025/10/floorplan.svg',
      link: '/floorplan',
      width: 60,
      height: 60,
    },
    {
      id: 'partners',
      title: 'Partners',
      icon: '/bengaluruskillsummit/wp-content/uploads/2025/10/sponsors-exhibitors.svg',
