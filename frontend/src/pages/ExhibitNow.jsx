...
export default function ExhibitNow() {
  useEffect(() => {
    document.title = 'Exhibit Now | Bengaluru Skill Summit 2025';
    window.scrollTo(0, 0);

    let intervalId = null;

    const renderHubspot = () => {
      const container = document.getElementById('hubspot-exhibit-form');
  ...
  return (
    <div className="bss-exhibit-page" style={{ fontFamily: '"Comfortaa", sans-serif', color: '#0e1220' }}>
      <style>{`
        /* ---------------- HERO BANNER ---------------- */
        .bss-exhibit-hero {
          width: 100%;
      ...
      {/* Hero Banner */}
      <section className="bss-exhibit-hero">
        <div className="bss-exhibit-hero__container">
          <h1 className="bss-exhibit-hero__title">
            EXHIBIT NOW
          </h1>
        </div>
      </section>
      ...
      {/* HubSpot Form Section */}
      <section className="bss-exhibit-form-section">
        <div className="bss-exhibit-form-container">
          <div id="hubspot-exhibit-form"></div>
        </div>
      </section>
