...
export default function KaushalyaKarnatakaAwards2026() {
  ...
  const slideInstCat = (direction) => {
    const track = document.getElementById('instCatTrack');
    if (track) {
      const card = track.querySelector('.kka-inst-cat-card');
  ...
  const scrollToSection = (targetId, event) => {
    ...
    if (targetId.startsWith('inst-')) {
      setActiveTab('institutional');
    } else if (targetId.startsWith('corp-') || targetId === 'award-categories' || targetId === '2025-winners') {
  ...
  useEffect(() => {
    ...
    const institutionalHero = document.getElementById('hero-content-institutional');
    const corporatePanel = document.getElementById('panel-corporate');
    const institutionalPanel = document.getElementById('panel-institutional');
    const btnCorporate = document.getElementById('tab-btn-corporate');
    const btnInstitutional = document.getElementById('tab-btn-institutional');

    if (activeTab === 'corporate') {
      if (corporateHero) corporateHero.style.display = 'flex';
      if (institutionalHero) institutionalHero.style.display = 'none';
      if (corporatePanel) { corporatePanel.classList.add('active'); corporatePanel.style.display = 'block'; }
      if (institutionalPanel) { institutionalPanel.classList.remove('active'); institutionalPanel.style.display = 'none'; }
      if (btnCorporate) btnCorporate.classList.add('active');
      if (btnInstitutional) btnInstitutional.classList.remove('active');
    } else {
      if (corporateHero) corporateHero.style.display = 'none';
      if (institutionalHero) institutionalHero.style.display = 'flex';
      if (corporatePanel) { corporatePanel.classList.remove('active'); corporatePanel.style.display = 'none'; }
      if (institutionalPanel) { institutionalPanel.classList.add('active'); institutionalPanel.style.display = 'block'; }
      if (btnCorporate) btnCorporate.classList.remove('active');
      if (btnInstitutional) btnInstitutional.classList.add('active');
    }
  }, [activeTab]);

  return (
    <div className="kka-awards-page-root">
      <style>{`
        * {
...
/* =========================================
  ...
  /* Button: #FF6257 / borderRadius: 12px / height: 42px / Jost 14px 700 */
  .kka-showcase-btn {
...
/* =========================================
  ...
  /* Buttons: #FF6257, borderRadius: 12px, Jost 14px 700 */
  .figma-cta-btn-row {
    display: flex;
    gap: 14px;
    align-items: center;
...
/* =========================================
  ...
  {/*  ========================================================
       1. HERO SECTION WITH TABS
       ========================================================  */}
  {/*  Google Fonts (Include in your <head> if not already added)  */}
...
<section className="awards-section">
  <div className="header-content">
    <h1 className="main-title">The Kaushalya Karnataka Awards</h1>
    <h2 className="subtitle">Celebrating Excellence in Skills</h2>
    <p className="hero-date-venue">5 November 2026 | The Grand Awards Ceremony | The Lalit Ashok, Bengaluru</p>
  </div>

  {/*  TABS BAR  */}
  <div className="tabs-outer-line-wrapper">
    <div className="tabs-container">
      <button id="tab-btn-corporate" className="tab-btn active" onClick={() => switchHeroTab('corporate')}>
      ...
      <button id="tab-btn-institutional" className="tab-btn" onClick={() => switchHeroTab('institutional')}>
        <span className="tab-icon-wrap">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {/*  TAB CONTENT: CORPORATE EXCELLENCE  */}
  <div id="hero-content-corporate" className="hero-tab-content">
    <div className="text-content">
      <div className="kka-hero-badge-wrap">
        <img 
          src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/powered-by-logo.png" 
      ...
      <h2 className="section-title">
        <span>RECOGNIZING INDUSTRY LEADERSHIP</span>
        <span>IN SKILLING</span>
      </h2>
      <p className="description">
        The Kaushalya Karnataka Corporate Excellence Awards honour organisations that are transforming the workforce through impactful skilling initiatives, industry-academia partnerships, and sustainable employment upskilling practices.
      </p>
      <div className="action-buttons">
        <a href="#award-categories" className="outline-btn" onClick={(e) => scrollToSection('award-categories', e)}>VIEW AWARD CATEGORIES</a>
        <a href="#2025-winners" className="outline-btn" onClick={(e) => scrollToSection('2025-winners', e)}>EXPLORE 2025 WINNERS</a>
      </div>
      <div>
        <a href="https://bengaluruskillsummit.com/kaushalya-awards-registration/" target="_blank" rel="noopener noreferrer" className="primary-btn">APPLY NOW FOR 2026 AWARDS</a>
      </div>
    </div>

    <div className="image-content">
      <img 
        src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/Group-1410089690.png" 
  ...
  {/*  TAB CONTENT: INSTITUTIONAL EXCELLENCE  */}
  <div id="hero-content-institutional" className="hero-tab-content" style={{ 'display': 'none' }}>
    <div className="text-content">
      <h2 className="section-title">
        <span>RECOGNIZING INSTITUTIONAL</span>
        <span>LEADERSHIP IN SKILLING</span>
      </h2>
      <p className="description">
        The Kaushalya Karnataka Institutional Excellence Awards celebrate ITIs, GTTCs, polytechnics, training centres and community organisations driving employability, industry collaboration, inclusivity and impactful skilling initiatives.
      </p>
      <div className="action-buttons">
        <a href="#inst-award-categories" className="outline-btn" onClick={(e) => scrollToSection('inst-award-categories', e)}>VIEW AWARD CATEGORIES</a>
        <a href="#inst-2025-winners" className="outline-btn" onClick={(e) => scrollToSection('inst-2025-winners', e)}>EXPLORE 2025 WINNERS</a>
      </div>
    </div>

    <div className="image-content">
      <img 
        src="https://bengaluruskillsummit.com/wp-content/uploads/2026/05/Group-1410089602.png" 
...
{/*  JAVASCRIPT TAB CONTROLLER  */}


  {/*  ========================================================
       TAB 1: CORPORATE EXCELLENCE AWARDS (ACTIVE)
       ========================================================  */}
  <main id="panel-corporate" className="tab-content-panel active">
    
    {/*  2. ABOUT THE AWARDS & 4 PILLARS  */}
    

<section className="about-section-wrapper">
  <div className="about-container">
    
    {/*  Heading matching exact Figma specs  */}
    ...
    <div className="features-grid">
      <div className="feature-item">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/Group-1410089695.svg" alt="Promote industry-led skilling" className="feature-icon" />
        <div className="feature-text">Promote industry-<br />led skilling</div>
      </div>
      <div className="feature-item">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/Group-1410089693.svg" alt="Encourage workforce transformation" className="feature-icon" />
        <div className="feature-text">Encourage workforce<br />transformation</div>
      </div>
      <div className="feature-item">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/Group-1410089692.svg" alt="Strengthen collaboration" className="feature-icon" />
        <div className="feature-text">Strengthen industry-<br />government and Industry -<br />Academia collaboration</div>
      </div>
      <div className="feature-item">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/Group-1410089691.svg" alt="Enhance employability" className="feature-icon" />
    ...
    <div className="policy-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/08/ChatGPT-Image-May-26-2026-04_46_56-PM-2-scaled.png" alt="Karnataka Skill Development Policy 2025-30" className="policy-image" />
    </div>
...
<div className="kka-why-matter-section">
  <h2 className="about-heading-blue">WHY THESE AWARDS MATTER</h2>
  <p className="kka-why-matter-subhead">In a rapidly evolving economic landscape, organisations play a crucial role in building a future-ready workforce.</p>
  <p className="kka-why-matter-intro">These awards recognise companies that:</p>

  <div className="kka-why-matter-flow">
    <div className="kka-why-matter-item">
      <div className="kka-why-matter-circle-wrap">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/why-this-matter-1.jpg" alt="Step 01" className="kka-why-matter-circle-img" />
      </div>
      <p className="kka-why-matter-text">Showcase your organisation's skilling initiatives and measurable outcomes.</p>
    </div>
    <div className="kka-why-matter-arrow">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
    </div>
    <div className="kka-why-matter-item">
      <div className="kka-why-matter-circle-wrap">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/why-this-matter-2.jpg" alt="Step 02" className="kka-why-matter-circle-img" />
      </div>
      <p className="kka-why-matter-text">Gain recognition for your contribution to Karnataka's workforce and skill ecosystem.</p>
    </div>
    <div className="kka-why-matter-arrow">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
    </div>
    <div className="kka-why-matter-item">
      <div className="kka-why-matter-circle-wrap">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/why-this-matter-3.jpg" alt="Step 03" className="kka-why-matter-circle-img" />
      </div>
      <p className="kka-why-matter-text">Benchmark your efforts through a structured, evidence-based evaluation.</p>
    </div>
    <div className="kka-why-matter-arrow">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
    </div>
    <div className="kka-why-matter-item">
      <div className="kka-why-matter-circle-wrap">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/why-this-matter-4.jpg" alt="Step 04" className="kka-why-matter-circle-img" />
      </div>
      <p className="kka-why-matter-text">Highlight impactful and scalable skilling practices.</p>
    </div>
    <div className="kka-why-matter-arrow">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
    </div>
    <div className="kka-why-matter-item">
      <div className="kka-why-matter-circle-wrap">
        <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/why-this-matter-5.jpg" alt="Step 05" className="kka-why-matter-circle-img" />
      </div>
      <p className="kka-why-matter-text">Celebrate your commitment to building a skilled, inclusive and future-ready workforce.</p>
    </div>
  </div>

  <p className="kka-why-matter-summary">
    The awards recognise organisations that are helping build a future-ready workforce through industry-led skilling, inclusion, innovation, workforce transformation and stronger links between skills and employment.
  </p>
</div>

    {/*  4. AWARD CATEGORIES (BEFORE WHY PARTICIPATE AS PER FIGMA)  */}
    

<section id="award-categories" className="kka-categories-wrap">
  <div className="kka-categories-inner">
    <h2 className="kka-cat-main-title">AWARD CATEGORIES</h2>
    <p className="kka-cat-subtitle">Awards will be presented across the following segments:</p>
    <h3 className="kka-cat-section-title">By Organisation Type</h3>
  ...
  <defs>
    ...
    <div style={{ 'textAlign': 'center', 'marginTop': '35px' }}>
      <a href="https://bengaluruskillsummit.com/kaushalya-awards-registration/" target="_blank" rel="noopener noreferrer" className="kka-participate-btn">APPLY NOW</a>
    </div>
  </div>
</section>
...
<div className="kka-participate-wrap">
  <div className="kka-participate-inner">
    <div>
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Group-1410089698.png" alt="Ceremony Presentation Collage" className="kka-participate-collage-img" />
    </div>
    <div style={{ 'textAlign': 'left' }}>
      <h2 className="kka-participate-title">WHY PARTICIPATE</h2>
      <div className="kka-participate-list">
        <div className="kka-participate-item">
          <div className="kka-participate-icon-box">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
          </div>
          <p className="kka-participate-text">National-level recognition</p>
        </div>
        <div className="kka-participate-item">
          <div className="kka-participate-icon-box">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
          </div>
          <p className="kka-participate-text">Position your organisation as a leader in skilling</p>
        </div>
        <div className="kka-participate-item">
          <div className="kka-participate-icon-box">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
          </div>
          <p className="kka-participate-text">Showcase impact to government & industry</p>
        </div>
        <div className="kka-participate-item">
          <div className="kka-participate-icon-box">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
          </div>
          <p className="kka-participate-text">Networking with policymakers, academia, and industry leaders</p>
        </div>
        <div className="kka-participate-item">
          <div className="kka-participate-icon-box">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
          </div>
          <p className="kka-participate-text">Enhance employer brand and credibility</p>
        </div>
      </div>
      <a href="https://bengaluruskillsummit.com/kaushalya-awards-registration/" target="_blank" rel="noopener noreferrer" className="kka-participate-btn">APPLY NOW</a>
    </div>
    ...
    {/*  6. EVALUATION FRAMEWORK (UPDATED 86PX HD ICONS)  */}
    

<div className="kka-eval-section">
  {/*  Section Titles  */}
  <h2 className="kka-eval-main-heading">EVALUATION FRAMEWORK</h2>
  <p className="kka-eval-subtitle">The evaluation framework is designed to assess real impact, not just activity.</p>

  {/*  4 Cards Grid  */}
  <div className="kka-eval-grid">
    
    {/*  Card 1: Reach & Karnataka Impact  */}
    <div className="kka-eval-card card-blue">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/eval1.png" alt="Reach & Karnataka Impact" className="kka-eval-icon-img" />
      <h3 className="kka-eval-title">Reach &<br />Karnataka Impact</h3>
      <div className="kka-eval-divider divider-blue"></div>
      <ul className="kka-eval-list">
        <li><span className="eval-bullet bullet-blue">•</span><span>Karnataka learners trained</span></li>
        <li><span className="eval-bullet bullet-blue">•</span><span>Workforce coverage</span></li>
        <li><span className="eval-bullet bullet-blue">•</span><span>Structured skilling reach beyond own employees</span></li>
      </ul>
    </div>

    {/*  Card 2: Inclusion  */}
    <div className="kka-eval-card card-pink">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/eval2.png" alt="Inclusion" className="kka-eval-icon-img" />
      <h3 className="kka-eval-title">Inclusion</h3>
      <div className="kka-eval-divider divider-pink"></div>
      <ul className="kka-eval-list">
        <li><span className="eval-bullet bullet-pink">•</span><span>Women participation</span></li>
        <li><span className="eval-bullet bullet-pink">•</span><span>Rural and underserved groups</span></li>
        <li><span className="eval-bullet bullet-pink">•</span><span>Inclusive-group participation</span></li>
      </ul>
    </div>

    {/*  Card 3: Quality & Relevance  */}
    <div className="kka-eval-card card-yellow">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/eval3.png" alt="Quality & Relevance" className="kka-eval-icon-img" />
      <h3 className="kka-eval-title">Quality &<br />Relevance</h3>
      <div className="kka-eval-divider divider-yellow"></div>
      <ul className="kka-eval-list">
        <li><span className="eval-bullet bullet-yellow">•</span><span>NSQF / NOS / SSC alignment</span></li>
        <li><span className="eval-bullet bullet-yellow">•</span><span>Future and emerging-skills share</span></li>
        <li><span className="eval-bullet bullet-yellow">•</span><span>Certification rate</span></li>
      </ul>
    </div>

    {/*  Card 4: Skilling Outcomes & Impact  */}
    <div className="kka-eval-card card-green">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/eval4.png" alt="Skilling Outcomes & Impact" className="kka-eval-icon-img" />
      <h3 className="kka-eval-title">Skilling Outcomes<br />& Impact</h3>
      <div className="kka-eval-divider divider-green"></div>
      <ul className="kka-eval-list">
        <li><span className="eval-bullet bullet-green">•</span><span>Apprenticeships</span></li>
        <li><span className="eval-bullet bullet-green">•</span><span>Internships / Fellowships</span></li>
        <li><span className="eval-bullet bullet-green">•</span><span>External employment and livelihood</span></li>
        <li><span className="eval-bullet bullet-green">•</span><span>Internal mobility</span></li>
        <li><span className="eval-bullet bullet-green">•</span><span>Demonstrated skilling impact</span></li>
      </ul>
    </div>
    ...
    {/*  7. FIVE STEPS FROM NOMINATION TO RECOGNITION & 2026 TIMELINE  */}
    {/*  Google Fonts (Include if not already in your header)  */}
...
<div className="kka-timeline-wrapper">
  ...
  {/*  Heading  */}
  <h2 className="kka-timeline-heading">FIVE STEPS FROM NOMINATION TO RECOGNITION</h2>

  {/*  PART 1: 5 STEPS (Hover effect on badges)  */}
  <div className="kka-steps-row">
    {/*  01  */}
    <div className="kka-step-col">
      <div className="kka-step-badge">01</div>
      <h3 className="kka-step-heading">NOMINATION</h3>
      <p className="kka-step-desc">Organisations nominate themselves for the Kaushalya Karnataka Corporate Excellence Awards 2026.</p>
    </div>

    {/*  02  */}
    <div className="kka-step-col">
      <div className="kka-step-badge">02</div>
      <h3 className="kka-step-heading">PARTICIPATION</h3>
      <p className="kka-step-desc">Eligible organisations complete and submit the detailed award application.</p>
    </div>

    {/*  03  */}
    <div className="kka-step-col">
      <div className="kka-step-badge">03</div>
      <h3 className="kka-step-heading">EVALUATION</h3>
      <p className="kka-step-desc">Applications are assessed through a structured, evidence-based evaluation.</p>
    </div>

    {/*  04  */}
    <div className="kka-step-col">
      <div className="kka-step-badge">04</div>
      <h3 className="kka-step-heading">JURY VALIDATION</h3>
      <p className="kka-step-desc">Shortlisted entries are reviewed and validated by the independent jury panel.</p>
    </div>

    {/*  05  */}
    <div className="kka-step-col">
      <div className="kka-step-badge">05</div>
      <h3 className="kka-step-heading">RECOGNITION</h3>
      <p className="kka-step-desc">Winners are recognised at the Kaushalya Karnataka Corporate Excellence Awards 2026.</p>
    </div>
  </div>

  {/*  PART 2: 2026 CYCLE APPLICATION TIMELINE BAR  */}
  <div className="figma-timeline-bar">
    
    {/*  Title  */}
    <div className="figma-timeline-title-wrap">
      <div className="figma-timeline-title">Application Timeline</div>
      <div className="figma-timeline-subtitle">2026 CYCLE</div>
    </div>

    {/*  Milestones (Green pill at Recognition is the final point)  */}
    <div className="figma-milestones-track">
      
      {/*  1. Launch  */}
      <div className="figma-milestone-item">
        <div className="figma-green-pill"></div>
        <div className="figma-step-label">Launch</div>
        <div className="figma-step-date" style={{ 'fontSize': '15px' }}>Sep 2026</div>
      </div>

      <div className="figma-connector-line"></div>

      {/*  2. Nomination Deadline  */}
      <div className="figma-milestone-item">
        <div className="figma-green-pill"></div>
        <div className="figma-step-label">Nomination<br/>Deadline</div>
        <div className="figma-step-date">9 Oct 2026</div>
      </div>
      ...
      <div className="figma-milestone-item">
        <div className="figma-green-pill"></div>
        <div className="figma-step-label">Application<br/>Deadline</div>
        <div className="figma-step-date">16 Oct 2026</div>
      </div>
      ...
      <div className="figma-milestone-item">
        <div className="figma-green-pill"></div>
        <div className="figma-step-label">Jury Review</div>
        <div className="figma-step-date">23 Oct 2026</div>
      </div>

      <div className="figma-connector-line"></div>

      {/*  5. Recognition (Final endpoint: no dashed line after this)  */}
      <div className="figma-milestone-item">
        <div className="figma-green-pill"></div>
        <div className="figma-step-label">Recognition</div>
        <div className="figma-step-date">5 Nov 2026</div>
      </div>

    </div>

    {/*  Apply Button  */}
    <a href="https://bengaluruskillsummit.com/kaushalya-awards-registration/" target="_blank" rel="noopener noreferrer" className="figma-apply-btn">Apply now</a>

  </div>

</div>

    {/*  8. 2025 WINNERS SHOWCASE  */}
    

<section id="2025-winners" className="kka-showcase-section">
  
  {/*  Subtle Background Watermark Icons  */}
  <svg className="showcase-watermark watermark-top-left" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
    <line x1="8" y1="21" x2="16" y2="21" />
    <line x1="12" y1="17" x2="12" y2="21" />
  </svg>

  <svg className="showcase-watermark watermark-bottom-left" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M2 20h20" />
    <path d="M5 20V8l5 4V8l5 4V4h4v16" />
  </svg>

  <svg className="showcase-watermark watermark-top-right" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  <svg className="showcase-watermark watermark-bottom-right" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {/*  Centered Content  */}
  <div className="kka-showcase-inner">
    <h2 className="kka-showcase-title">
      Celebrate the organisations recognised in 2025 for their exceptional contributions to skilling.
    </h2>
    <a href="https://bengaluruskillsummit.com/kaushalya-karnataka-awards-2025" className="kka-showcase-btn" target="_blank" rel="noopener noreferrer">
      2025 WINNERS SHOWCASE
    </a>
  </div>

</section>

    {/*  9. CTA SPLIT SECTION (Rectangle-112098.png & PROPER CASING)  */}
    

<div className="figma-cta-section">
  
  {/*  Left Column: Ceremony Photo  */}
  <div className="figma-cta-photo-col">
    <img 
      src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Rectangle-112098.png" 
      alt="Bengaluru Skill Summit Awards Ceremony" 
    />
  </div>

  {/*  Right Column: Content  */}
  <div className="figma-cta-text-col">
    
    {/*  Headline  */}
    <h2 className="figma-cta-head">
      Be part of Karnataka’s most prestigious skilling recognition platform.
    </h2>

    {/*  Subhead  */}
    <h3 className="figma-cta-subhead">Application Timeline</h3>

    {/*  Timeline Box  */}
    <div className="figma-cta-timeline-box">
      
      {/*  Launch  */}
      <div className="figma-cta-timeline-unit">
        <div className="figma-icon-gold">
          {/*  Gift Box SVG Icon  */}
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#F5B919" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 7.5c-1.5-2-4-2-4 0s2.5 2 4 2z" />
            <path d="M12 7.5c1.5-2 4-2 4 0s-2.5 2-4 2z" />
            <rect x="3" y="9.5" width="18" height="4" rx="1" />
            <path d="M5 13.5v6.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-6.5" />
            <line x1="12" y1="9.5" x2="12" y2="21" />
          </svg>
        </div>
        <p className="figma-date-text">
          <span className="figma-date-label">Launch:</span>
          <span className="figma-date-value"> September 2026</span>
        </p>
      </div>

      {/*  Vertical Divider  */}
      <div className="figma-cta-timeline-divider"></div>

      {/*  Deadline  */}
      <div className="figma-cta-timeline-unit">
        <div className="figma-icon-red">
          {/*  Stopwatch Timer SVG Icon  */}
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FF6257" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="13.5" r="7" />
            <polyline points="12 10 12 13.5 14 14.5" />
            <path d="M12 3v3" />
            <path d="M10 2.5h4" />
          </svg>
        </div>
        <p className="figma-date-text">
          <span className="figma-date-label">Deadline:</span>
          <span className="figma-date-value"> 9 October 2026</span>
        </p>
      </div>
    ...
    {/*  Buttons Row  */}
    <div className="figma-cta-btn-row">
      <a href="https://bengaluruskillsummit.com/kaushalya-awards-registration/" target="_blank" rel="noopener noreferrer" className="figma-cta-btn">APPLY NOW</a>
    </div>
    ...
    {/*  10. ORGANISED BY & PARTNERS (Corporate: includes In Partnership With)  */}
    

<div className="kka-corp-partners-wrap">
  {/*  Organised By Column  */}
  <div className="kka-corp-partner-col">
    <h3 className="kka-corp-partner-title">Organised by</h3>
    <div className="kka-corp-logo-box">
      <img 
        src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Group-1410089643.svg" 
        alt="Organised by: Government of Karnataka, Kaushalya Karnataka" 
      />
    </div>
  </div>

  {/*  In Partnership With Column  */}
  <div className="kka-corp-partner-col">
    <h3 className="kka-corp-partner-title">In Partnership with</h3>
    <div className="kka-corp-logo-box">
      <img 
        src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Logo-2-1.svg" 
        alt="In Partnership with: Workplace Awards, Initiative by Zyoin Group" 
      />
    </div>
  </div>
</div>

    {/*  11. FULL-WIDTH CONTACT BOX  */}
    

<div className="kka-contact-box">
  <h3 className="kka-contact-box-title">Contact for more information</h3>
  <p className="kka-contact-box-desc">
    Email: <a href="mailto:bengaluruskillsummit@workplaceawards.in">bengaluruskillsummit@workplaceawards.in</a> | Phone: +91 80503 14499 (Sushpit Ghosh)
  </p>
</div>
  ...
  {/*  ========================================================
       ...
       ========================================================  */}
  <main id="panel-institutional" className="tab-content-panel">
    
    {/*  INSTITUTIONAL ABOUT SECTION (2-COLUMNS + GROUP COLLAGE + 8 LOGOS)  */}
    {/*  Google Fonts (Include if not already in your header)  */}
...
<section className="kka-inst-about-section">
  {/*  Top Split Row: Text Content + Photo Collage  */}
  <div className="kka-inst-about-grid">
    
    {/*  Left: Heading and Body Description  */}
    <div className="kka-inst-text-col">
      <h2 className="kka-inst-main-title">
        Recognising Excellence in<br />
        Skill Development Education<br />
        &amp; Training
      </h2>
      <p className="kka-inst-paragraph">
        The Kaushalya Karnataka Institutional Excellence Awards at <strong>Bengaluru Skill Summit (5 November 2026 at The Lalit Ashok, Bengaluru)</strong>, under Department of Skill Development, Entrepreneurship &amp; Livelihood, <strong>Government of Karnataka</strong> honour the backbone of Karnataka’s skilling ecosystem – districts, ITIs, GTTCs, polytechnics, training centres, and community partners. The awards are not just accolades – they are a tribute to the educators, administrators, and community champions who are shaping the next generation of skilled professionals.
      </p>
      <p className="kka-inst-paragraph">
        Initiated by <strong>KSDA and the Government of Karnataka</strong>, these recognitions celebrate innovation in training delivery, strong industry linkages, and measurable impact on employability.
      </p>
    </div>

    {/*  Right: Collage Image  */}
    <div className="kka-inst-img-col">
      <img 
        src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Group-1410089698.png" 
        alt="Kaushalya Karnataka Institutional Awards Presentation" 
        className="kka-inst-collage-img"
      />
    </div>

  </div>

  {/*  Bottom Row: 8 Institutional Partner Logos  */}
  <div className="kka-inst-logos-grid">
    {/*  1. BMV NTFSA  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/6452d877628f036f4261ea69b2024948212788e9.jpg" alt="BMV NTFSA" />
    </div>

    {/*  2. Dept of Industrial Training and Employment  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/8590a7d8c9438e75bea4d20878c1f6ad04cabe84.png" alt="Department of Industrial Training and Employment" />
    </div>

    {/*  3. Industrial Training Institute (ITI)  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/bc073dc429b2223ee0264b86d01412b82f9c6b79.jpg" alt="Industrial Training Institute ITI" />
    </div>

    {/*  4. GTTC  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/1893620c458726851cfb47c9455cfc2bfeea35ed.png" alt="GTTC" />
    </div>

    {/*  5. KGTTI  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/ba5c8f006702d18d63738ceb2722d7ae9cd350cf.jpg" alt="KGTTI" />
    </div>

    {/*  6. Sanjeevini NRLM  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/2ad70e0fc6d649ee65172aff042084908cdffd06.jpg" alt="Sanjeevini NRLM" />
    </div>

    {/*  7. Asmita  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/d9a7755fd2916feeb0a05526b14f39296b4facb4.png" alt="Asmita" />
    </div>

    {/*  8. Aajeevika  */}
    <div className="kka-inst-logo-card">
      <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/524cfbb21383b9ee939e7140ae086fb5d0aa0c01.jpg" alt="Aajeevika" />
    </div>
  </div>
</section>

    {/*  INSTITUTIONAL AWARD CATEGORIES SECTION (CAROUSEL / GRID MATCHING FIGMA)  */}
    {/*  ========================================================
     INSTITUTIONAL AWARD CATEGORIES SECTION (CAROUSEL / GRID)
     ========================================================  */}


<section id="inst-award-categories" className="kka-inst-cat-section">
  <div className="kka-inst-cat-inner">
    <h2 className="kka-inst-cat-title">AWARD CATEGORIES</h2>
    <h3 className="kka-inst-cat-subtitle">Institutional Excellence Awards In Skilling</h3>

    <div className="kka-inst-cat-carousel-wrap">
      {/*  Prev Arrow  */}
      <button type="button" className="kka-inst-cat-nav kka-inst-cat-prev" onClick={() => slideInstCat(-1)} aria-label="Previous categories">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <polyline points="15 18 9 12 15 6" />
        </svg>
      </button>

      {/*  Scrollable Track with 6 Cards  */}
      <div id="instCatTrack" className="kka-inst-cat-track">
        
        {/*  Card 1  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-1.svg" alt="Best District for Skill Development" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">Best District for Skill Development</p>
        </div>

        {/*  Card 2  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-2.svg" alt="Best Institutions in Skill Competitions" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">Best Institutions in Skill Competitions</p>
        </div>

        {/*  Card 3  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-3.svg" alt="Best Performing ITIs – Government, Private, and Aided" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">Best Performing ITIs – Government, Private, and Aided</p>
        </div>

        {/*  Card 4  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-4.svg" alt="Best Performing GTTCs and KGTTIs" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">Best Performing GTTCs and KGTTIs</p>
        </div>

        {/*  Card 5  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-5.svg" alt="NLM (SHGs) / Other Private Partners – Special Recognition" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">NLM (SHGs) / Other Private Partners – Special Recognition</p>
        </div>

        {/*  Card 6  */}
        <div className="kka-inst-cat-card">
          <img src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/icn-6.svg" alt="Trainer, Principal and Trainee Awards" className="kka-inst-cat-icon" />
          <p className="kka-inst-cat-text">Trainer, Principal and Trainee Awards</p>
        </div>

      </div>

      {/*  Next Arrow  */}
      <button type="button" className="kka-inst-cat-nav kka-inst-cat-next" onClick={() => slideInstCat(1)} aria-label="Next categories">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/*  2025 WINNERS SHOWCASE FOR INSTITUTIONAL  */}
    

<section id="inst-2025-winners" className="kka-showcase-section">
  ...
  <div className="kka-showcase-inner">
    ...
    {/*  ORGANISED BY (Institutional: Organised by only)  */}
    

<div className="kka-inst-partners-wrap">
  <h3 className="kka-inst-organised-title">Organised by</h3>
  <img 
    src="https://bengaluruskillsummit.com/wp-content/uploads/2026/09/Group-1410089643.svg" 
    alt="Organised by: Government of Karnataka, Kaushalya Karnataka" 
    className="kka-inst-organised-svg" 
  />
</div>
  ...
  {/*  ========================================================
       JAVASCRIPT TAB CONTROLLER & SLIDER
       ========================================================  */}
