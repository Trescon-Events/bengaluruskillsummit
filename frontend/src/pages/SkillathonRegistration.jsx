...
export default function SkillathonRegistration() {
  useEffect(() => {
    document.title = 'Skillathon Registration - Bengaluru Skill Summit';
    window.scrollTo(0, 0);

    let intervalId = null;

    const renderHubspot = () => {
      const container = document.getElementById('hubspot-skillathon-form');
      if (window.hbspt && container) {
        // Prevent duplicate creation if already rendered
    ...
    // Guardian: If HubSpot inadvertently appends form to body, move it to the container
    const guardian = () => {
      const container = document.getElementById('hubspot-skillathon-form');
      if (!container) return;
  ...
  return (
    <div className="bss-skill-reg-page" style={{ fontFamily: '"Comfortaa", sans-serif', color: '#0e1220' }}>
      <style>{`
        /* ---------------- HERO BANNER ---------------- */
        .bss-skill-reg-hero {
          width: 100%;
      ...
      {/* Hero Banner */}
      <section id="Skill-Reg-Banner" className="bss-skill-reg-hero">
        <div className="bss-skill-reg-hero__container">
          <div className="bss-skill-reg-hero__card">
            <h1 className="bss-skill-reg-hero__title">
              Skillathon Registration
            </h1>
            <p className="bss-skill-reg-hero__subtitle">
      ...
      {/* HubSpot Form Section - Centered directly above Contact Info & Footer */}
      <section className="bss-skill-reg-form-section">
        <div className="bss-skill-reg-form-container">
          <div id="hubspot-skillathon-form"></div>
        </div>
      </section>
