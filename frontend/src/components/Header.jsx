              ...
              <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
                ...
                <li style={{ borderBottom: "1px solid #f0f0f0", padding: "10px 0" }}>
                  ...
                  {openSubMenus.highlights && (
                    <ul style={{ listStyle: "none", paddingLeft: "16px", marginTop: "8px", margin: 0 }}>
                      <li style={{ padding: "8px 0" }}><Link to="/2025-highlights" onClick={closeMobileMenu} style={{ color: "#555", textDecoration: "none", fontSize: "15px" }}>2025 Highlights Overview</Link></li>
