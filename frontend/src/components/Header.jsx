          ...
          <div className="inner">
            <div className="menu-items-wrap row" data-has-secondary-text="false">
              <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
                <li style={{ borderBottom: "1px solid #282828", padding: "10px 0" }}>
                  <Link to="/" onClick={closeMobileMenu} style={{ color: "#ffffff", fontWeight: 600, fontSize: "16px", textDecoration: "none" }}>Home</Link>
                </li>
                <li style={{ borderBottom: "1px solid #282828", padding: "10px 0" }}>
                  <Link to="/about-us" onClick={closeMobileMenu} style={{ color: "#ffffff", fontWeight: 600, fontSize: "16px", textDecoration: "none" }}>About</Link>
                </li>
                <li style={{ borderBottom: "1px solid #282828", padding: "10px 0" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer" }} onClick={(e) => toggleSubMenu('highlights', e)}>
                    <span style={{ color: "#ffffff", fontWeight: 600, fontSize: "16px" }}>2025 Highlights</span>
                    {openSubMenus.highlights ? <FaAngleUp style={{ fontSize: "18px", color: "#ffffff" }} /> : <FaAngleDown style={{ fontSize: "18px", color: "#ffffff" }} />}
                  </div>
                  {openSubMenus.highlights && (
                    <ul style={{ listStyle: "none", paddingLeft: "16px", marginTop: "8px", margin: 0 }}>
                      <li style={{ padding: "8px 0" }}><Link to="/speakers-2025" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Speakers</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/agenda" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Full Agenda</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/snapshot-agenda" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Snapshot Agenda</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/exhibitors" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Exhibitors</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/ecosystem-partners" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Partners</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/media-partners" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Media Partners</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/curtain-raiser" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Curtain Raiser</Link></li>
                      <li style={{ padding: "8px 0" }}><Link to="/kaushalya-karnataka-awards-2025" onClick={closeMobileMenu} style={{ color: "#cccccc", textDecoration: "none", fontSize: "15px" }}>Awards</Link></li>
                    </ul>
                  )}
                </li>
