import{i as e,r as t,t as n}from"./index-6FqKRopo.js";e();var r=n();function i({active:e=`AGENDA`}){return(0,r.jsxs)(`div`,{className:`bss-screen-header-bar`,children:[(0,r.jsxs)(`div`,{className:`bss-screen-header-inner`,children:[(0,r.jsx)(`div`,{className:`bss-screen-logo-wrap`,children:(0,r.jsx)(t,{to:`/details/`,title:`Bengaluru Skill Summit`,children:(0,r.jsx)(`img`,{src:`/bengaluruskillsummit/wp-content/uploads/2025/09/bss-logo-white.svg`,alt:`bss logo white`,className:`bss-screen-logo`,decoding:`async`,fetchpriority:`high`,loading:`eager`,width:492,height:157})})}),(0,r.jsx)(`div`,{className:`bss-screen-buttons-wrap`,children:[{label:`HOME`,path:`/details/`},{label:`AGENDA`,path:`/agenda-screen/`},{label:`FLOORPLAN`,path:`/floorplan-screen/`},{label:`PARTNERS`,path:`/partners-screen/`}].map(n=>(0,r.jsx)(t,{to:n.path,className:`bss-screen-btn ${e===n.label?`active`:``}`,children:(0,r.jsx)(`span`,{children:n.label})},n.label))})]}),(0,r.jsx)(`style`,{children:`
