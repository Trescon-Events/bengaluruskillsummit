import{o as e,s as t,t as n}from"./index-B0dymM_5.js";import{t as r}from"./partners2026Fallback-1nPoGto1.js";var i=t(e(),1),a=n();function o(e){let t=[];return e&&Array.isArray(e.categorized)&&(t=e.categorized.filter(e=>(e.category_name||``).toLowerCase().includes(`media`)&&Array.isArray(e.entity)&&e.entity.length>0)),t}function s(){let[e,t]=(0,i.useState)(()=>o(r)),[n,s]=(0,i.useState)(!1),[c,l]=(0,i.useState)(null);return(0,i.useEffect)(()=>{document.title=`Media Partners 2026 | Bengaluru Skill Summit`,window.scrollTo(0,0);let e=!0;return fetch(`https://api.konfhub.com/event/public/bengaluru-skill-summit-2026/entity/2`).then(e=>{if(!e.ok)throw Error(`API status ${e.status}`);return e.json()}).then(n=>{if(!e)return;let r=o(n);r.length>0&&t(r),s(!1)}).catch(t=>{e&&(console.warn(`KonfHub API warning, using static fallback:`,t),s(!1))}),()=>{e=!1}},[]),(0,a.jsxs)(`div`,{className:`media-partners-2026-page`,children:[(0,a.jsx)(`style`,{children:`
        /* ==========================================
