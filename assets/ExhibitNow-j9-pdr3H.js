import{i as e,r as t,t as n}from"./index-o3qWaFlO.js";var r=e(t(),1),i=n();function a(){return(0,r.useEffect)(()=>{document.title=`Exhibit Now | Bengaluru Skill Summit 2025`,window.scrollTo(0,0);let e=null,t=()=>{let e=document.getElementById(`hubspot-exhibit-form`);if(window.hbspt&&e){if(e.querySelector(`form`)||e.querySelector(`.hbspt-form`))return;e.innerHTML=``,window.hbspt.forms.create({portalId:`2953901`,formId:`6fed7aff-c103-4f0f-bcdf-44c94020e81d`,region:`na1`,target:`#hubspot-exhibit-form`,onFormSubmitted:function(){window.location.href=`/thank-you`}})}},n=()=>{let e=document.getElementById(`hubspot-exhibit-form`);e&&document.querySelectorAll(`body > .hbspt-form, body > div > .hbspt-form`).forEach(t=>{e.contains(t)||e.appendChild(t)})};if(window.hbspt)t();else{let e=document.querySelector(`script[src*="hsforms.net"]`);if(e)e.addEventListener(`load`,t);else{let e=document.createElement(`script`);e.src=`https://js.hsforms.net/forms/embed/v2.js`,e.charset=`utf-8`,e.type=`text/javascript`,e.async=!0,e.onload=t,document.body.appendChild(e)}}return e=setInterval(n,500),()=>{e&&clearInterval(e)}},[]),(0,i.jsxs)(`div`,{className:`bss-exhibit-page`,style:{fontFamily:`"Comfortaa", sans-serif`,color:`#0e1220`},children:[(0,i.jsx)(`style`,{children:`
        /* ---------------- HERO BANNER ---------------- */
        .bss-exhibit-hero {
          width: 100%;
          min-height: 380px;
