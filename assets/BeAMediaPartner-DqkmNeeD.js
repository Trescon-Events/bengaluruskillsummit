import{o as e,s as t,t as n}from"./index-DxY2J4fY.js";var r=t(e(),1),i=n();function a(){return(0,r.useEffect)(()=>{document.title=`Be a Media Partner | Collaborate with Bengaluru Skill Summit 2025`,window.scrollTo(0,0);let e=null,t=()=>{let e=document.getElementById(`hubspot-media-partner-form`);if(window.hbspt&&e){if(e.querySelector(`form`)||e.querySelector(`.hbspt-form`))return;e.innerHTML=``,window.hbspt.forms.create({portalId:`2953901`,formId:`61c72a0c-d238-4738-92c3-5abf5653f887`,region:`na1`,target:`#hubspot-media-partner-form`,onFormSubmitted:function(){window.location.href=`/thank-you`}})}},n=()=>{let e=document.getElementById(`hubspot-media-partner-form`);e&&document.querySelectorAll(`body > .hbspt-form, body > div > .hbspt-form`).forEach(t=>{e.contains(t)||e.appendChild(t)})};if(window.hbspt)t();else{let e=document.querySelector(`script[src*="hsforms.net"]`);if(e)e.addEventListener(`load`,t);else{let e=document.createElement(`script`);e.src=`https://js.hsforms.net/forms/embed/v2.js`,e.charset=`utf-8`,e.type=`text/javascript`,e.async=!0,e.onload=t,document.body.appendChild(e)}}return e=setInterval(n,500),()=>{e&&clearInterval(e)}},[]),(0,i.jsxs)(`div`,{className:`bss-media-partner-page`,style:{fontFamily:`"Comfortaa", sans-serif`,color:`#0e1220`},children:[(0,i.jsx)(`style`,{children:`
        /* ---------------- HERO BANNER ---------------- */
        ...
        .bss-media-partner-hero__container {
          max-width: 1100px;
          width: 100%;
          margin: 0 auto;
          position: relative;
